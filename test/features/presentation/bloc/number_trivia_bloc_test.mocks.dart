...
// in tdd_clean_architecture/test/features/presentation/bloc/number_trivia_bloc_test.dart.
...
import 'package:tdd_clean_architecture/core/error/failures.dart' as _i6;
import 'package:tdd_clean_architecture/core/usecase/usecase.dart' as _i9;
import 'package:tdd_clean_architecture/core/util/input_converter.dart' as _i10;
...
class MockGetConcreteNumberTrivia extends _i1.Mock
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, _i7.NumberTrivia>> call(int? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [params],
...
/// A class which mocks [GetRandomTrivia].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetRandomTrivia extends _i1.Mock implements _i8.GetRandomTrivia {
  MockGetRandomTrivia() {
    _i1.throwOnMissingStub(this);
  }
